...
public interface InvGroupMapper {
    ...
    @Mapping(source = "dateCreateGI", target = "fechaCreacionGI")
    @Mapping(source = "add", target = "adicional")
    ...
    @Mapping(source = "fechaCreacionGI", target = "dateCreateGI")
    @Mapping(source = "adicional", target = "add")
